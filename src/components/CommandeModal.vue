                ...
                >
                  ...
                  <div class="mt-6">
                    <input
                      ...
                      type="text"
                      required=""
                      placeholder="Votre Adresse (n° rue - CP VILLE)"
                      aria-label="Adresse"
                    />
                  </div>
                  <div class="mt-6">
                    <textarea
                      ...
                      rows="6"
                      aria-label="Details"
                      placeholder="Votre commande (Produit - volume - quantité. ex : Parfum La petite robe noir - 100ml - 1)"
                    ></textarea>
                  </div>
